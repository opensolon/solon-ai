 ...
 * <li><b>递归映射</b>：自动保留原始目录结构，逻辑严密地映射到压缩包内部。</li>
 * <li><b>防自锁机制</b>：智能检测并排除正在生成的 ZIP 文件本身，避免递归嵌套异常。</li>
 * </ul>
 * </p>
 *
 * @author noear
 ...
 */
@Preview("3.9.1")
public class ZipTalent extends AbsTalent {
    private static final Logger LOG = LoggerFactory.getLogger(ZipTalent.class);
    private final Path rootPath;
    private final Charset charset;

    public ZipTalent(String workDir) {
        this(workDir, StandardCharsets.UTF_8);
    }

    public ZipTalent(String workDir, Charset charset) {
