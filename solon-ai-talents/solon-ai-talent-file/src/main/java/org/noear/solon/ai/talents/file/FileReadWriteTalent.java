 ...
 */
@Preview("3.9.1")
public class FileReadWriteTalent extends AbsTalent {
    private static final Logger LOG = LoggerFactory.getLogger(FileReadWriteTalent.class);
    private final Path rootPath;
    private final Charset charset;
    private static final int MAX_READ_SIZE = 1024 * 24;

    public FileReadWriteTalent(String workDir) {
        this(workDir, StandardCharsets.UTF_8);
    }

    public FileReadWriteTalent(String workDir, Charset charset) {
