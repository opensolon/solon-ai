 ...
 */
package org.noear.solon.ai.talents.restapi;
...
import org.noear.solon.ai.talents.restapi.resolver.OpenApiResolver;
...
@Deprecated
@Preview("3.9.1")
public class RestApiTalent extends AbsTalent {
    private static final Logger LOG = LoggerFactory.getLogger(RestApiTalent.class);
    ...
    public RestApiTalent retryConfig(int maxRetries, long retryDelayMs) {
        this.maxRetries = Math.max(1, maxRetries);
        return this;
    }

    public RestApiTalent retryConfig(int maxRetries) {
        this.maxRetries = Math.max(1, maxRetries);
        return this;
    }
    ...
    public RestApiTalent dynamicThreshold(int dynamicThreshold) {
        this.dynamicThreshold = dynamicThreshold;
        return this;
    }

    public RestApiTalent listThreshold(int listThreshold) {
        this.listThreshold = listThreshold;
        return this;
    }

    public RestApiTalent searchThreshold(int searchThreshold) {
        this.searchThreshold = searchThreshold;
        return this;
    }

    public RestApiTalent maxContextLength(int length) {
        this.maxContextLength = length;
        return this;
    }

    public RestApiTalent defaultAuthenticator(ApiAuthenticator defaultAuthenticator) {
        this.defaultAuthenticator = defaultAuthenticator;
        return this;
    }

    public RestApiTalent resolver(ApiResolver resolver) {
        if (resolver != null) {
     ...
     */
    public RestApiTalent addApi(String docUrl, String apiBaseUrl) {
     ...
     * @param apiBaseUrl 实际接口执行基地址
     */
    public RestApiTalent addApi(String docUrl, String apiBaseUrl, Map<String, String> headers) {
     ...
     * @param apiBaseUrl 实际接口执行基地址
     */
    public RestApiTalent addApi(String docUrl, String apiBaseUrl, Map<String, String> headers, ApiAuthenticator authenticator) {
     ...
     * @param apiSource 接口源
     */
    public RestApiTalent addApi(ApiSource apiSource) {
     ...
     * @param docUrl OpenAPI 定义地址 (http://... 或 classpath:...)
     */
    public RestApiTalent removeApi(String docUrl) {
