 ...
 * <li><b>隔离执行</b>：基于 {@link AbsProcessTalent} 提供的沙箱路径、输出截断与超时保护。</li>
 * </ul>
 * </p>
 *
 * @author noear
 ...
 */
@Preview("3.9.1")
public class ShellTalent extends AbsProcessTalent {
    private static enum ShellMode {
        CMD, POWERSHELL, UNIX_SHELL
    }
    private static final Logger LOG = LoggerFactory.getLogger(ShellTalent.class);

    private final String shellCmd;
    private final String extension;
    private final ShellMode shellMode;

    public ShellTalent(String workDir) {
        super(workDir);
