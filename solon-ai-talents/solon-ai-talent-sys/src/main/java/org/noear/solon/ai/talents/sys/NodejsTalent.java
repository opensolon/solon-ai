...
/**
 * Node.js 脚本执行工具包：为 AI 提供高精度的逻辑计算与 JavaScript 生态扩展能力。
 *
 * <p>该工具包允许 Agent 在受控的本地环境中运行异步 JavaScript 代码，核心价值包括：
 * <ul>
 ...
 */
@Preview("3.9.1")
public class NodejsTalent extends AbsProcessTalent {
    private static final Logger LOG = LoggerFactory.getLogger(NodejsTalent.class);

    public NodejsTalent(String workDir) {
        super(workDir);
    }
