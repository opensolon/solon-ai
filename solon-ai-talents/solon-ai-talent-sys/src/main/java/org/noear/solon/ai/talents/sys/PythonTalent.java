 ...
 */
@Preview("3.9.1")
public class PythonTalent extends AbsProcessTalent {
    private static final Logger LOG = LoggerFactory.getLogger(PythonTalent.class);

    private final String pythonCmd;

    public PythonTalent(String workDir) {
        this(workDir, probePythonCmd());
    }

    public PythonTalent(String workDir, String pythonCmd) {
        super(workDir);
