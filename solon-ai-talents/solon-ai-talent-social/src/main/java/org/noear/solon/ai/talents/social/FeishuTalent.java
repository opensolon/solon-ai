 ...
 */
package org.noear.solon.ai.talents.social;
...
/**
 * 飞书助手工具包：为 AI 提供飞书（Lark）平台的深度协同与信息推送能力。
 *
 * <p>该工具包基于飞书自定义机器人 Webhook 实现，具备以下核心逻辑：
 * <ul>
 ...
 */
@Preview("3.9.1")
public class FeishuTalent extends AbsWebhookTalent {
    private final String secret;

    public FeishuTalent(String webhookUrl) {
        this(webhookUrl, null);
    }

    public FeishuTalent(String webhookUrl, String secret) {
        super(webhookUrl);
        this.secret = secret;
    }
