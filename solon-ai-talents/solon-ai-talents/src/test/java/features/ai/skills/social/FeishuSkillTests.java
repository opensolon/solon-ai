...
import org.noear.solon.ai.skills.social.FeishuSkill;
...
public class FeishuSkillTests {
    ...
    public FeishuSkill getSocialSkill() {
        return new FeishuSkill(apiUrl);
    }

    @Test
    public void testMarkdownLogic() {
        FeishuSkill skill = getSocialSkill();
    ...
    public void testAgentDrivenNotification() throws Throwable {
        ...
        SimpleAgent agent = SimpleAgent.of(LlmUtil.getChatModel())
                .role("运维告警助手")
                .defaultTalentAdd(getSocialSkill())
                .build();
