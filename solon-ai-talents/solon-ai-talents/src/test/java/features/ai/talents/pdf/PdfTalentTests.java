package features.ai.talents.pdf;
 ...
 */
public class PdfTalentTests {

    private final String workDir = "./test_workspace";
    private PdfTalent pdfTalent;
    ...
    public void setup() throws IOException {
        ...
        pdfTalent = new PdfTalent(workDir, () -> {
            try {
    ...
    public void testCreateChineseMarkdown() throws IOException {
        ...
        String result = pdfTalent.create(fileName, mdContent, "markdown");
        ...
        String parsedText = pdfTalent.parse(fileName);
    ...
    public void testAgentComplexTask() throws Throwable {
        ...
        String content = pdfTalent.parse("budget.pdf");
