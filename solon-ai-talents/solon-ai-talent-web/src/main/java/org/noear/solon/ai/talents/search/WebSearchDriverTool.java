 ...
 */
package org.noear.solon.ai.talents.search;
 ...
 */
@Preview("3.9.1")
public class WebSearchDriverTool extends AbsToolProvider {
    private static final Logger LOG = LoggerFactory.getLogger(WebSearchDriverTool.class);

    private final String apiKey;
    private final SearchDriver driver;
    private int maxResults = 5;

    public WebSearchDriverTool(SearchDriver driver, String apiKey) {
        this.driver = driver;
        this.apiKey = apiKey;
    }

    public WebSearchDriverTool maxResults(int maxResults) {
