 ...
 */
package org.noear.solon.ai.talents.crawler;
 ...
 */
@Preview("3.9.1")
public class WebCrawlerDriverTool extends AbsToolProvider {
    private static final Logger LOG = LoggerFactory.getLogger(WebCrawlerDriverTool.class);

    private final String apiKey;
    private final CrawlerDriver driver;

    public WebCrawlerDriverTool(CrawlerDriver driver, String apiKey) {
        this.driver = driver;
        this.apiKey = apiKey;
    }
