 ...
 */
package org.noear.solon.ai.talents.lucene;
 ...
 * @since 3.9.1
 */
public class LuceneTalent extends AbsTalent {
    private static final Logger LOG = LoggerFactory.getLogger(LuceneTalent.class);
    private static final LuceneTalent instance = new LuceneTalent();

    public static LuceneTalent getInstance() {
        return instance;
    }
    ...
    public LuceneTalent(String workDir) {
     ...
     * 设置忽略的文件名或目录名
     */
    public LuceneTalent ignoreNames(Collection<String> names) {
     ...
     * 设置允许索引的文件后缀 (不带点)
     */
    public LuceneTalent searchableExtensions(Collection<String> exts) {
        if (exts != null) {
