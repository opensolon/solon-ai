package org.noear.solon.ai.talents.pdf;
 ...
 */
@Preview("3.9.1")
public class PdfTalent extends AbsTalent {
    private static final Logger LOG = LoggerFactory.getLogger(PdfTalent.class);
     ...
     */
    public PdfTalent(String workDir) {
     ...
     */
    public PdfTalent(String workDir, Supplier<InputStream> fontSupplier) {
