 ...
 */
package org.noear.solon.ai.talents.text2sql;
...
import org.noear.solon.ai.talents.text2sql.dialect.GenericDialect;
 ...
 * <li><b>执行安全护栏</b>：强制只读校验（SELECT-only）、自动分页注入（LIMIT 防雪崩）以及标识符修复（Alias Repairing）。</li>
 * <li><b>语义关联引导</b>：自动提取外键关系（Foreign Keys）与表备注，为 AI 提供语义化的“关联线索”，提升多表 Join 的准确性。</li>
 * </ul>
 * </p>
 *
 * @author noear
 ...
 */
@Preview("3.9.1")
public class Text2SqlTalent extends AbsTalent {
    protected final static Logger LOG = LoggerFactory.getLogger(Text2SqlTalent.class);
    ...
    public Text2SqlTalent(DataSource dataSource, String... tables) {
        this(SqlUtils.of(dataSource), tables);
    }

    public Text2SqlTalent(SqlUtils sqlUtils, String... tables) {
        super();
    ...
    public Text2SqlTalent maxRows(int maxRows) { this.maxRows = maxRows; return this; }
    public Text2SqlTalent maxContextLength(int length) { this.maxContextLength = length; return this; }
    public Text2SqlTalent schemaMode(SchemaMode schemaMode) { this.schemaMode = schemaMode; return this; }
    public Text2SqlTalent readOnly(boolean readOnly) { this.readOnly = readOnly; return this; }

    public Text2SqlTalent dialect(SqlDialect dialect) {
