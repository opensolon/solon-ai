package org.noear.solon.ai.talents.mail;
 ...
 */
@Preview("3.9.1")
public class MailTalent extends AbsTalent {
    private static final Logger LOG = LoggerFactory.getLogger(MailTalent.class);
    private final Path rootPath;
    private final Mailer mailer;
    private final String fromEmail;

    public MailTalent(String workDir, String host, int port, String username, String password) {
