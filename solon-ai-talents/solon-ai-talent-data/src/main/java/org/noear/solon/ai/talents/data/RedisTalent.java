 ...
 */
package org.noear.solon.ai.talents.data;
...
/**
 * Redis 存储才能：为 AI 提供跨会话的“长期记忆”能力
 *
 * <p>该才能允许 AI Agent 将关键信息（如用户偏好、任务中间状态、历史事实）以 Key-Value 形式持久化。
 *  相比于 Context Window 的短期记忆，本才能提供了可跨越不同会话周期的状态保持方案。</p>
 *
 * @author noear
 * @since 3.9.1
 */
@Preview("3.9.1")
public class RedisTalent extends AbsTalent {
    private static final Logger LOG = LoggerFactory.getLogger(RedisTalent.class);
    private final RedisClient redis;
    private final String keyPrefix;
    private static final String BASE_PREFIX = "ai:memory:";

    public RedisTalent(RedisClient redis) {
        this(redis, null);
    }
     ...
     */
    public RedisTalent(RedisClient redis, String keyPrefix) {
        this.redis = redis;
