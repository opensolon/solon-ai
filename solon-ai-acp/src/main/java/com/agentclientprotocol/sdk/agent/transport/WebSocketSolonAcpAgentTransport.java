 ...
 *
 * <p>
 * This transport registers a WebSocket route via {@link WebSocketRouter} that listens
 * for WebSocket connections on the configured path. When a client connects, messages
 * are exchanged as JSON-RPC messages over WebSocket text frames.
 * </p>
 *
 * <p>
 * Key features:
 * <ul>
 * <li>Solon WebSocket server integration via WebSocketRouter</li>
...
public class WebSocketSolonAcpAgentTransport implements AcpAgentTransport {
	...
	/**
	 * Creates a new WebSocketSolonAcpAgentTransport with default path.
	 * @param jsonMapper The JsonMapper to use for JSON serialization/deserialization
	 */
	public WebSocketSolonAcpAgentTransport(AcpJsonMapper jsonMapper) {
		this(DEFAULT_ACP_PATH, jsonMapper);
	}

	/**
	 * Creates a new WebSocketSolonAcpAgentTransport on the specified path.
	 * @param path The WebSocket endpoint path (e.g., "/acp")
	 * @param jsonMapper The JsonMapper to use for JSON serialization/deserialization
	 */
	public WebSocketSolonAcpAgentTransport(String path, AcpJsonMapper jsonMapper) {
	...
	public Mono<Void> start(Function<Mono<JSONRPCMessage>, Mono<JSONRPCMessage>> handler) {
		...
		return Mono.fromCallable(() -> {
			...
			// Register Solon WebSocket route
	...
	/**
	 * Solon WebSocket endpoint for handling client connections.
	 */
