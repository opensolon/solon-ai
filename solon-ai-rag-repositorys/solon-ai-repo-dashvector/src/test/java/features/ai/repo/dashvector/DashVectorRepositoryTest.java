...
import org.noear.solon.ai.rag.repository.DashVectorRepository;
 ...
 * DashVector 测试类
 *
 * 详情参考https://www.aliyun.com/product/ai/dashvector，可以领取免费试用版本
 * 免费试用版本有go
 * @author 小奶奶花生米
 */
@SolonTest
public class DashVectorRepositoryTest {
    private DashVectorRepository repository;
    private static final String SERVER_URL = "https://vrs-cn-m4148rby90007j.dashvector.cn-hangzhou.aliyuncs.com";
    private static final String API_KEY = "sk-4BcNds0pzjSsHOTipOi3YpFMHjmTi3A0A1A4E265D11F09E89AE1437865CFD";
    private static final String COLLECTION_NAME = "test_collection";
    final String apiUrl = "http://127.0.0.1:11434/api/embed";
    final String provider = "ollama";
    final String model = "bge-m3:latest";
    ...
    public void deleteCollection() throws Exception{
        // 因为使用的是免费试用版本，有 collection 的上限，每次运行完后进行删除
    ...
    private void load(DashVectorRepository repository, String url) throws IOException {
