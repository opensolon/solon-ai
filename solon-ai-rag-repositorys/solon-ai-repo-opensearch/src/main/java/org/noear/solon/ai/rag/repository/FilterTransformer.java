...
public class FilterTransformer implements Transformer<Boolean, Map<String, Object>> {
     ...
     *
     * @param field 字段名
     * @param value 值（可包含通配符 * 和 ?）
     * @return 查询对象
     */
    private Map<String, Object> createWildcardQuery(String field, String value) {
        Map<String, Object> wildcardValue = new HashMap<>();
        wildcardValue.put("value", value);

        Map<String, Object> wildcard = new HashMap<>();
        wildcard.put(field, wildcardValue);
