 ...
 */
package org.noear.solon.ai.rag.repository.aliyun.dashvector;
...
public class FilterTransformer implements Transformer<Boolean, String> {
    ...
    /**
     * 解析 QueryCondition 中的过滤表达式，转换为 DashVector 支持的过滤条件格式
     *
     * @param filterExpr 查询条件
     * @return DashVector 过滤表达式，格式为字符串，如：age > 18 and weight > 65.0 and male = true
     */
    @Override
    ...
    /**
     * 解析 Expression 对象形式的过滤表达式
     *
     * @param filterExpression 过滤表达式对象
     * @return DashVector 过滤表达式字符串
     */
