...
public class ShellSkill extends AbsProcessSkill {
    ...
    public ShellSkill(String workDir) { this(workDir, "/bin/sh"); }
    public ShellSkill(String workDir, String shellCmd) {
        super(workDir);
        this.shellCmd = shellCmd;
    }

    @Override public String name() { return "shell_executor"; }
    @Override public String description() { return "Shell 专家：执行系统命令，管理文件或查询环境。"; }
