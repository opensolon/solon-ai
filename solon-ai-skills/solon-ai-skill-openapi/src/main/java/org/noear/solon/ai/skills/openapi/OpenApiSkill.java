...
import org.noear.solon.ai.skills.openapi.resolver.OpenApiResolver;
...
public class OpenApiSkill extends AbsSkill {
    ...
    public OpenApiSkill retryConfig(int maxRetries, long retryDelayMs) {
        this.maxRetries = Math.max(1, maxRetries);
        return this;
    }

    public OpenApiSkill retryConfig(int maxRetries) {
        this.maxRetries = Math.max(1, maxRetries);
        return this;
    }
    ...
    public OpenApiSkill dynamicThreshold(int dynamicThreshold) {
        this.dynamicThreshold = dynamicThreshold;
        return this;
    }

    public OpenApiSkill listThreshold(int listThreshold) {
        this.listThreshold = listThreshold;
        return this;
    }

    public OpenApiSkill searchThreshold(int searchThreshold) {
    ...
    public OpenApiSkill resolver(ApiResolver resolver) {
        if (resolver != null) {
     ...
     */
    public OpenApiSkill addApi(String docUrl, String apiBaseUrl) {
     ...
     * @param apiBaseUrl 实际接口执行基地址
     */
    public OpenApiSkill addApi(String docUrl, String apiBaseUrl, Map<String, String> headers) {
     ...
     * @param apiBaseUrl 实际接口执行基地址
     */
    public OpenApiSkill addApi(String docUrl, String apiBaseUrl, Map<String, String> headers, ApiAuthenticator authenticator) {
