 ...
 */
@Preview("3.9.0")
public class McpTalentClient implements Talent {
    /**
    ...
    public McpTalentClient(McpClientProvider clientProvider) {
        ...
        String metadataJson = clientProvider.readResource("talent://metadataMcp")
                .getContent();
    ...
    /**
     * 跨进程准入检查：请求远程服务端判断当前 Prompt 环境是否允许激活该才能
     */
    @Override
