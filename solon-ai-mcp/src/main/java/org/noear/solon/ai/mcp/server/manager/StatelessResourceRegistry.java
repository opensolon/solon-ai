...
public class StatelessResourceRegistry implements McpPrimitivesRegistry<FunctionResource> {
    ...
    private void addRef(McpServerProperties mcpServerProps, FunctionResource functionResource) {
        try {
            //resourceSpec
            McpStatelessServerFeatures.AsyncResourceSpecification resourceSpec = new McpStatelessServerFeatures.AsyncResourceSpecification(
    ...
    private void addTml(McpServerProperties mcpServerProps, FunctionResource functionResource) {
        try {
            //resourceSpec
            McpStatelessServerFeatures.AsyncResourceTemplateSpecification resourceSpec = new McpStatelessServerFeatures.AsyncResourceTemplateSpecification(
