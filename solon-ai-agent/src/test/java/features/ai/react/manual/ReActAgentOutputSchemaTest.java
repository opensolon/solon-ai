package features.ai.react.manual;
...
public class ReActAgentOutputSchemaTest {
    ...
    public void outputSchema() throws Throwable {
        ...
        ReActAgent resumeAgent = ReActAgent.of(chatModel)
                ...
                .retryConfig(3, 2000L)
                // 配置模型参数
                .modelOptions(o -> o.temperature(0.1D))
                .build();
        ...
        Assertions.assertEquals(message.getContent(), message.getText());
