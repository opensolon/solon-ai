 ...
 * @since 3.1
 */
public class OllamaRerankingDialect extends AbstractRerankingDialect {
    private static OllamaRerankingDialect instance = new OllamaRerankingDialect();

    public static OllamaRerankingDialect getInstance() {
        return instance;
    }
