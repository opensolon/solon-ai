...
public class Query3Test {
    ExpressionEvaluator parser = new DefaultExpressionEvaluator();
    ...
    public void case1() {
        ...
        Expression root = parser.compile(expression);
    ...
    public void case5() {
        // 数学运算 (Long)
        Integer result = (Integer) parser.eval("1+2+3");
        System.out.println(result); // 6
        assert 6 == result;

        // 数学运算 (Double)
        Double result2 = (Double) parser.eval("1.1+2.2+3.3");
        System.out.println(result2); // 6.6
        assert 6.6D == result2;

        // 包含关系运算和逻辑运算
        Boolean result3 = (Boolean) parser.eval("(1>0||0<1)&&1!=0");
        System.out.println(result3); // true
        assert result3 == true;

        // 三元运算
        String result4 = (String) parser.eval("4 > 3 ? \"4 > 3\" : 999");
    ...
    public void case6() {
        ...
        Integer rst = (Integer) parser.eval("(a + b) * 2", context);
    ...
    public void case7() {
        ...
        Object result = parser.eval(expression, context);
